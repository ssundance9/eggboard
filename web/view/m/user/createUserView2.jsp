            ...
            <div class="join_wrap">
                ...
                <div class="step clearfix">
                    <ul>
                        ...
                        <li class="step02 active"><i></i>필수정보</li>
                        ...
                        <ul class="info_table">
                            ...
                            <li>
                                ...
                                <div class="phone_area">
                                    ...
                                    <span class="btn small codecheck"><a href="/">확인</a></span> -->
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                <div class="right">
                                    ...
                                    <div>
                                        <input type="text" id="allhenNo" class="" name="allhenNo" placeholder="" >
                                    </div>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="body">
                    ...
                    <div class="tab_con tab_con01">
                        <div class="address_fome">
                            ...
                            <span class="btn_big search"><a href="#">조회</a></span>
                        </div>
