                            ...
                            <div class="join_info">
                                <ul class="info_table">
                                    ...
                                    <li>
                                        ...
                                        <div>
                                            <input type="password" id="userPw" class="" name="userPw" value="${member.userPw }" placeholder="영문/숫자/특수문자 조합 6~12자" maxlength="12">
                                    ...
                                    <li>
                                        ...
                                        <div>
                                            <input type="password" id="userPwChk" class="" name="userPwChk" value="${member.userPw }" placeholder="영문/숫자/특수문자 조합 6~12자" maxlength="12">
