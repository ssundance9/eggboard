                                    ...
                                    <tbody>
                                        <c:forEach var="user" items="${userList}">
                                            <tr id="${user.userId}">
                                                ...
                                                <td>
                                                    <fmt:formatDate value="${user.regDtm}" pattern="yyyy.MM.dd"/>
                                                </td>
                                                <td>
                                                    <fmt:formatDate value="${user.confirmDtm}" pattern="yyyy.MM.dd"/>
                                                </td>
                                                <td>
                                                    <input type="text" name="serialNo" value="${user.serialNo}" maxlength="30">
                                                </td>
                                                <td>
                                                    <c:if test="${empty user.serialNo}">
                                                        <button type="button" onclick="confirmSerialNo('${user.userId}');">승인</button>
                                                    </c:if>
                                                    <c:if test="${not empty user.serialNo}">
                                                        <button type="button" onclick="reConfirmSerialNo('${user.userId}');">변경</button>
                                                    </c:if>
                                                </td>
                                            </tr>
                                        </c:forEach>
